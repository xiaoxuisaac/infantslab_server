"""
Django settings for infantslab_server project.
...
SECRET_KEY = 'tp13yt0p5v+xma)eyy%gr(v_p!91ooss98_h5aoif16*v$8nx6'
...
ROOT_URLCONF = 'infantslab_server.urls'
...
WSGI_APPLICATION = 'infantslab_server.wsgi.application'
